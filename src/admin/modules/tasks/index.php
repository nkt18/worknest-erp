...
apiFetch("<?= htmlspecialchars(appRoute('api.tasks')) ?>")
...
apiFetch("<?= htmlspecialchars(appRoute('api.projects')) ?>")
...
apiFetch("<?= htmlspecialchars(appRoute('api.users')) ?>")
...
apiFetch(`<?= htmlspecialchars(appRoute('api.tasks')) ?>?id=${editId.value}`,{
...
apiFetch(`<?= htmlspecialchars(appRoute('api.tasks')) ?>?id=${deleteId}`,{
