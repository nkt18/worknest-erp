...
apiFetch("<?= htmlspecialchars(appRoute('api.employees')) ?>")
...
apiFetch(`<?= htmlspecialchars(appRoute('api.employees')) ?>?id=${editId.value}`,{
...
apiFetch(`<?= htmlspecialchars(appRoute('api.employees')) ?>?id=${deleteId}`,{
